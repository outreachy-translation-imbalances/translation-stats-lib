...
from translation_stats import translator_language_proficiency_misc_babel_template
from translation_stats import translator_language_proficiency_standard_babel_template
from translation_stats import translator_language_proficiency_user_template
...
if __name__ == "__main__":
    ...
    translator_language_proficiency_misc_babel_template.generate_csv_files()
    translator_language_proficiency_standard_babel_template.generate_csv_files()
    translator_language_proficiency_user_template.generate_csv_files()
